...
$production_list = array(
	new Production(
		...
		可視化をテーマに初めて作った3Dゲーム
EOF
		, array(TECHTAG_CPP, TECHTAG_DXLIB, TECHTAG_WINDOWS, TECHTAG_VISUALSTUDIO), '2011年8月'
	),
	new Production(
		'タンクゲーム', '2Pシューティングアクションゲーム', <<<EOF
		ボンバーマン風ステージでシューティングするアクションゲーム.同じキーボードで2P対戦ができる.様々な武器アイテムが用意した
EOF
		, array(TECHTAG_CPP, TECHTAG_DXLIB, TECHTAG_WINDOWS, TECHTAG_VISUALSTUDIO), '2012年8月', NULL, NULL, array('Lamia_inase' => 'ステージ上のドット絵全般', 'karura820' => 'サウンド全般')
	),
	new Production(
...
EOF
		, array(TECHTAG_PHP, TECHTAG_GOOGLESCRIPT, TECHTAG_TWITTERAPI, TECHTAG_YAHOOAPI, TECHTAG_WINDOWS, TECHTAG_ECLIPSE), '2013年3月'
	),
	new Production(
...
EOF
		, array(TECHTAG_PHP, TECHTAG_JS, TECHTAG_PROCESSING, TECHTAG_PROCESSING_JS, TECHTAG_JQUERY, TECHTAG_TWITTERAPI, TECHTAG_TWITTERWEBAPI, TECHTAG_WINDOWS, TECHTAG_ECLIPSE), '2013年3月'
	),
	new Production(
		'Jenga Note', '大学の講義を掲示板風にオンラインでまとめて共有サイト', <<<EOF
		授業についてのメモを講義ごとのページで共有できるサービス.その時間に行われてる講義をわかりやすくしたり,メモが整理できるように特化した掲示板にした,Bootstrapを初めて使った
EOF
		, array(TECHTAG_PHP, TECHTAG_JQUERY, TECHTAG_LESS, TECHTAG_BOOTSTRAP, TECHTAG_WINDOWS, TECHTAG_MYSQL, TECHTAG_ECLIPSE, TECHTAG_VIM), '2013年11月'
	),
	new Production(
...
EOF
		, array(TECHTAG_JS, TECHTAG_LESS, TECHTAG_BOOTSTRAP, TECHTAG_WINDOWS, TECHTAG_ECLIPSE, TECHTAG_VIM), '2013年12月'
	),
	new Production(
...
EOF
		, array(TECHTAG_JAVA, TECHTAG_WINDOWS, TECHTAG_ECLIPSE, TECHTAG_VIM), '2014年1月'
	),
	new Production(
...
EOF
	...
	new Production(
		...
		大学のつながりで依頼されて作ったサイト
EOF
		, array(TECHTAG_PHP, TECHTAG_LESS, TECHTAG_BOOTSTRAP, TECHTAG_CODEIGNITER, TECHTAG_LINUX, TECHTAG_WINDOWS, TECHTAG_GIT, TECHTAG_NETBEANS, TECHTAG_VIM), '2014年7月'
	),
	new Production(
...
EOF
		, array(TECHTAG_JAVA, TECHTAG_TWITTERAPI, TECHTAG_JAVASERVLET, TECHTAG_BOOTSTRAP, TECHTAG_WINDOWS, TECHTAG_LINUX, TECHTAG_ECLIPSE, TECHTAG_NETBEANS, TECHTAG_VIM, TECHTAG_GIT), '2013年6月', NULL, NULL, array('sukonbu0909' => 'プロジェクトマネージャ', 'twinkfrag' => 'アプリケーションスペシャリスト', 'godslew' => 'ITアーキテクト', 'arzzup' => 'ITアーキテクト', 'munisystem' => '品質保証マネージャ')
	),
	new Production(
		'酔っ払った―', '酔っ払ったツイートができる簡易Webアプリ', <<<EOF
		フォームに入力したテキストを酔っ払った感じでツイートできる.酔っ払い具合の調節が可能.開発期間1日
EOF
		, array(TECHTAG_PHP, TECHTAG_LESS, TECHTAG_YAHOOAPI, TECHTAG_TWITTERAPI, TECHTAG_CODEIGNITER, TECHTAG_BOOTSTRAP, TECHTAG_LINUX, TECHTAG_NETBEANS, TECHTAG_VIM), '2014年6月'
	),
	new Production(
		'BirthdayAPI', '作品のキャラクター誕生日API', <<<EOF
		作品タイトル,キャラクター,日付,自分の見た作品などから指定してリクエストするとその結果が帰ってくる,GETしか作っていない,ユーザごとに作品の管理ができるが今のところ半手動
EOF
		, array(TECHTAG_PHP, TECHTAG_LINUX, TECHTAG_MYSQL, TECHTAG_POSTGRESQL, TECHTAG_VIM), '2014年7月'
	),
);
?>
